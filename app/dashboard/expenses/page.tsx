    ...
    <div className="px-5 pt-2 pb-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                          ...
                          {exp.paid_by === 'both' && (
                            <span className="text-[9px] px-1.5 py-0.5 rounded-full" style={{ backgroundColor: 'rgba(83,74,183,0.08)', color: '#534AB7' }}>
                              both
                            </span>
                          )}
                        </div>
      ...
      <div className="fixed right-5 z-40 flex items-center gap-2.5" style={{ bottom: 108 }}>
        ...
        <motion.button
          ...
          style={{
            ...
            color: importLoading ? 'rgba(0,0,0,0.25)' : 'rgba(0,0,0,0.5)',
          }}
        ...
        <motion.button
          ...
          style={{
            ...
            border: '1px solid rgba(0,0,0,0.08)',
            boxShadow: '0 4px 14px rgba(0,0,0,0.1)',
            color: scanning ? 'rgba(0,0,0,0.25)' : 'rgba(0,0,0,0.5)',
          }}
          title="Scan receipt"
        >
        ...
        <motion.button
          ...
          style={{
            backgroundColor: user?.color || '#534AB7',
            boxShadow: `0 6px 22px ${(user?.color || '#534AB7')}55`,
          }}
        >
          +
        </motion.button>
      ...
      <AnimatePresence>
        {showForm && (
          ...
          >
            <motion.div
              className="bg-white rounded-t-3xl w-full max-w-md mx-auto max-h-[86vh] flex flex-col"
              ...
              <div className="flex-1 overflow-y-auto px-6 pb-2" style={{ overscrollBehavior: 'contain' }}>
                ...
                <div className="flex gap-2 mb-4">
                  {([
                    ...
                    ['status', 'status', 'impressing others'] as const,
                  ]).map(([val, label, sub]) => (
                    <button
                      key={val}
                    ...
                    >
                      <p className="text-sm font-medium flex items-center gap-1.5" style={{ color: form.bucket === val ? (val === 'utility' ? '#1D9E75' : '#D97706') : 'rgba(0,0,0,0.5)' }}>
      ...
      <AnimatePresence>
        {showImport && (
          ...
          >
            <motion.div
              className="bg-white rounded-t-3xl w-full max-w-md mx-auto max-h-[88vh] flex flex-col"
              initial={{ y: '100%' }} animate={{ y: 0 }} exit={{ y: '100%' }}
              transition={{ type: 'tween', duration: 0.32, ease: [0.32, 0.72, 0, 1] }}
              onClick={e => e.stopPropagation()}
            >
              ...
              <div className="flex-1 overflow-y-auto px-6 pb-2 space-y-2" style={{ overscrollBehavior: 'contain' }}>
                {importItems.map(tx => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-5 h-5 rounded-full flex-shrink-0 flex items-center justify-center" style={{ backgroundColor: selected ? (user?.color || '#534AB7') : 'rgba(0,0,0,0.08)' }}>
                        {selected && (
