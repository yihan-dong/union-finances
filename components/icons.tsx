...
// CategoryIcon — specific SVG per ExpenseCategory
export function CategoryIcon({ category, size = 13 }: { category: string; size?: number }) {
  ...
  switch (category) {
    ...
    case 'entertainment':
      return <svg {...p}><rect x="2" y="2" width="20" height="20" rx="2.18"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="2" y1="7" x2="7" y2="7"/><line x1="2" y1="17" x2="7" y2="17"/><line x1="17" y1="17" x2="22" y2="17"/><line x1="17" y1="7" x2="22" y2="7"/></svg>
    case 'travel':
...
// IncomeTypeIcon — specific SVG per IncomeType
export function IncomeTypeIcon({ type, size = 13 }: { type: string; size?: number }) {
  const p = { width: size, height: size, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 1.9, strokeLinecap: 'round' as const, strokeLinejoin: 'round' as const }
  switch (type) {
    case 'salary':
...
export function HouseIcon({ size = 12 }: { size?: number }) {
  return (
